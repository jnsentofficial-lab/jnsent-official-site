                    ...
                    <div className="flex flex-col gap-[9.2rem]">
                        <SubPageSection title={"컨설팅 분야"}>
                            <div className="flex flex-col gap-[1.6rem]">
                                {consultingAreas.map((area) => (
                                    ...
                                    >
                                        <h3 className="text-[2.0rem] font-black text-black">{area.title}</h3>
                        ...
                        <SubPageSection title={"이런 분들께 추천드립니다"}>
                            <div className="m-0 grid gap-2 pl-5 text-lg font-semibold leading-[1.8] text-black">
                                <p>엔터테인먼트 사업을 처음 시작하시는 분</p>
                                <p>방송 스튜디오 운영을 준비 중이신 분</p>
                                <p>BJ 매니지먼트 운영 방향이 필요한 분</p>
                                <p>실제 운영 경험 기반의 현실적인 조언이 필요한 분</p>
                            </div>
                        </SubPageSection>

                        <SubPageSection title={`제이엔에스엔터테인먼트는\n실제 라이브 콘첸츠 운영 경험을 기반으로`} />

                        <SubPageSection title={`보다 안정적이고\n효율적인 운영 방향을 함께 고민합니다.`} />
                    </div>
                }
                right={
                    <InquiryRequestForm
