                ...
                <div style="padding:56px 42px 80px">
                    <div style="font-size:18px;line-height:1.7;color:#222222">
                        <div style="font-size:28px;font-weight:800;line-height:1;color:#222222;margin:0 0 8px">
                            <span style="color:#ff2253;margin:0">${escapeHtml(categoryLabel)}</span> 문의가 접수되었습니다.
                        </div>
                        <div style="font-size:28px;font-weight:800;line-height:1;margin:0 0 2px">
                            
                            <span style="color:#222222;margin:0">내용을 확인해주세요</span>
                        </div>
                    </div>
                </div>
                <div style="padding:0 42px 56px">
                    <div style="border-top:3px solid #2f343b;padding-top:20px">
                        <p style="margin:0 0 18px;font-size:15px;line-height:1.9;color:#4b4f56">
                            제이엔에스 엔터테인먼트 웹사이트를 통해 새로운 문의가 접수되었습니다. 아래 내용을 확인하신 뒤 필요한 후속 응대를 진행해주세요.
                        </p>
                        <p style="margin:0 0 34px;font-size:15px;line-height:1.9;color:#4b4f56">
                            접수 정보와 상세 문의 내용은 메일 하단에 정리되어 있으며, 문의자 정보와 요청 항목이 잘 구분되도록 구성했습니다.
                        </p>
                    </div>
                    ...
                    <div style="padding:54px 0 0;text-align:center">
                        <a href="https://jns-entertainment.com/admin/inquiries" style="display:inline-block;min-width:170px;padding:16px 28px;border-radius:16px;background:#000000;color:#ffffff;font-size:18px;font-weight:500;line-height:1;text-decoration:none">
                            문의 확인하기
                        </a>
                    </div>
                </div>
